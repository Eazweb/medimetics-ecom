        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-2">
            ...
            <p className="text-gray-300 text-sm mt-2">
              Ritesh Clothing Store brings you the latest fashion trends with
              quality and style.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-300 mb-2">Phone: 0123456789</p>
            <p className="text-gray-300 mb-4">Email: info@riteshclothing.com</p>
